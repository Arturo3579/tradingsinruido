...
El 90% de los traders individuales pierde dinero. No es un dato que inventé yo: es una realidad que se repite en estudio tras estudio de reguladores financieros de todo el mundo. La pregunta no es si el trading es imposible, sino **por qué la mayoría falla y qué hace el 10% que sobrevive**.

Tras años operando índices como el Nasdaq 100 y pares como el USD/JPY, puedo decirte con certeza: **la disciplina es más importante que cualquier estrategia**. No importa cuán buena sea tu estrategia si no la sigues con rigor. Un plan mediocre ejecutado con disciplina gana a un plan perfecto ejecutado con emociones.

<!-- 📢 BLOQUE DE ANUNCIO ADSENSE (In-Article) -- DESPUÉS DE LA INTRODUCCIÓN -->

## El 90% que falla: diagnóstico
...
**Dato real:** Según un estudio de la ESMA (Autoridad Europea de Valores y Mercados), el 74-89% de los traders minoristas pierde dinero en CFDs y Forex. No es una excepción: es la norma.
...
**Mi regla de oro:** Si moví el stop-loss después de abrir la operación, estoy operando con emociones, no con lógica. Esa operación ya está perdida, aunque gane dinero.
...
- **Mercados y horarios:** ¿En qué instrumentos operas? ¿A qué horas? (ej: solo EUR/USD y NQ, sesión de Nueva York)
- **Setup de entrada:** ¿Qué condiciones deben darse para abrir una operación? (ej: ruptura de Asia high + FVG en 15m)
- **Setup de salida:** ¿Dónde está tu stop-loss? ¿Dónde tu take-profit? ¿Hay trailing stop?
- **Gestión de riesgo:** ¿Qué porcentaje de tu capital arriesgas por operación? (máximo 1-2%)
- **Límite diario:** ¿Cuántas operaciones al día? ¿Cuánto puedes perder antes de cerrar la sesión?

**Ejemplo de mi plan:** Si pierdo 2 operaciones consecutivas, cierro la plataforma y no vuelvo hasta el día siguiente. No negociable.
...
**Ejemplo práctico:** Con 5,000€ de capital, mi riesgo máximo es de 50€ por operación (1%). Si el stop-loss me obliga a arriesgar 75€, no entro. No importa cuán buena se vea la operación.
...
- Fecha, hora, mercado y dirección
- Setup que te llevó a entrar (¿había Fair Value Gap? ¿Qué temporalidad?)
- Resultado en euros
- Emociones durante la operación (¿estabas tranquilo? ¿ansioso? ¿vengativo?)
- ¿Cumpliste tu plan al 100% o lo modificaste?

Reviso mi diario cada domingo. Es la herramienta más poderosa que tengo para detectar patrones destructivos: "Veo que en 80% de las operaciones que pierdo, las abro después de las 16:00 hora española". Con esa información, cambié mi horario de trading.
...
**Mi horario:** Sesión de Nueva York (14:30 - 17:00 hora española). Fuera de ese horario, la plataforma está cerrada. Punto.
...
He perdido más dinero operando con ira que operando con miedo. La ira te hace violar el plan. El miedo te hace no entrar. La ira es peor.

<!-- 📢 BLOQUE DE ANUNCIO ADSENSE (In-Article) -- DESPUÉS DE LAS 5 REGLAS -->
...
**¿Quieres construir disciplina desde el principio?** Lee nuestra guía sobre [cómo empezar en trading con poco capital](/blog/como-empezar-trading-desde-cero) y pon las bases de un plan que realmente puedas seguir.

---

*⚠️ **Descargo de responsabilidad:** Este contenido es únicamente con fines educativos e informativos. No constituye asesoramiento financiero, legal ni fiscal. El trading conlleva riesgo significativo y puede no ser adecuado para todos los inversores. Nunca inviertas dinero que no puedas permitirte perder. Los datos estadísticos sobre pérdidas de traders provienen de estudios de reguladores públicos y son referencias generales del mercado. Los resultados pasados no garantizan resultados futuros.*
